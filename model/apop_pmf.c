...
\adoc    Parameter_format  The \c parameters element is the weights matrix as above.    
\adoc    Settings   None.    
*/
...
\adoc    estimated_parameters  Blank---the \c weights vector holds all the useful information.    */
