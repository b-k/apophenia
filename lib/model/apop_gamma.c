...
apop_inventory  actual_uses    =    apop_inventory_filter(uses, apop_gamma.inventory_filter);
    return apop_maximum_likelihood(data->data, &actual_uses, apop_gamma, *(apop_estimation_params *)parameters);
}
