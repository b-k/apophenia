...
apop_inventory  actual_uses    =    apop_inventory_filter(uses, apop_zipf.inventory_filter);
    return apop_maximum_likelihood(data->data, &actual_uses, apop_zipf, *(apop_estimation_params *)parameters);
}
