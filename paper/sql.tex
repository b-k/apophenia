...
complements. Some things, like making a \airq{crosstab} or \airq{pivot
...
a file; then just change the \cinline{'d'} to an \cinline{'f'} and away you go.\footnote{Dots are common in file names but an annoyance in tables. So if the second argument to \cinline{apop\_data\_print} is \cinline{out.data.csv}, you will get that file name, but a table named \cinline{out\_data}, with no dots and everything after the last dot stripped away.}
