...
\paragraph{Pruning rows with \ttind{distinct}} The \ttind{distinct}
...
\paragraph{\ttind{Union}} For example, 
%[
select id, age, zip
from data_set_1
UNION
...
\paragraph{\ttind{Union all}} If a line is duplicated in both tables,
...
\paragraph{\ttind{Intersect}} As you can guess, {\tt intersect} returns
a single copy of only those lines that appear in both tables.

\paragraph{\ttind{Except}} This is the subtraction: it returns only
...
in a text file and using \ttind{apop\_\-text\_\-to\_\-db}. The form
...
including \ttind{apop\_\-que\-ry\_\-to\_\-ma\-trix} to pull a query to a {\tt
...
print functions: \ttind{a\-pop\_\-da\-ta\_\-print} and
...
\index{apop\_\-opts!output\_type@{\tt output\_type}}{\tt apop\_\-opts.output\_type}
%[
