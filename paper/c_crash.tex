...
\cind{rint} to round to integer: \ci{rounded\_val = rint(unrounded\_number)}.}
...
./run\_me} will first run \bi{make}, and halt if there are errors, and
...
y;}. Thus, all files that \ci{\#include} the header know what to make of
