...
loop. Here is a while loop to print \airq{hello} on the screen five times: \index{loops} \ttindex{while}
...
most useful would be \ttind{strcpy}, but see also \cinline{sprintf} below.
\begin{lstlisting}
#include <string.h>
...
one could write \cinline{b = (i > j); a += b; i++;} as 
\cinline{a += b = i++ > j;}. Some people find one-liners like
...
but you could live a successful career of C use without ever using it.
