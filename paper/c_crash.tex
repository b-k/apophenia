...
\cindex{<!in C, less than} \cindex{>} \cindex{==}
...
best means of doing this is via a \cind{for} loop.  The following \ci{for}
...
and so you have \cind{double}, which are real numbers written to twice
