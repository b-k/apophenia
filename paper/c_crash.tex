...
line, and could initialize \ci{counter} to zero right when we
declare it. The other variables (such as \ci{a\_variable}) have
...
need these. [The \airq{g} in \ci{\%g} stands for \airq{general format}, by the way.]
