...
of the delcarations for \binline{some\_functions.c} in a {\sl \ind{header
...
name with a colon after it. You can then jump to that line via \cind{goto}. Here is a code snippet that presents the basic idea, with a line labelled \cinline{outro}:
\begin{lstlisting}
