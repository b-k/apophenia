...
32 key words and this book will only use 17 of them. Some are basically
archaic, designed for the days when compilers needed help from the user to
optimize code. Others, like bit-shifting operators, will only be useful
...
to manipulate them.  But for most programs oriented toward statistical
...
\item Therefore, put function declarations in header files.
