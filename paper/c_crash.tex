...
\marginaliafixed{18}{Header aggregation}{The Apophenia library provides a convenience header that aggregates
...
just as we'd declare \cinline{int j} when \cinline{j} is an integer.} The
...
see Figure \ref{dummy}, page \pageref{dummy}, for an example.
