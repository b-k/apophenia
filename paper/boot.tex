...
\section{\ind{Markov Chain Monte Carlo}} If your data is described by
...
In other words, non-parametric
modeling involves writing down a parametrized model and estimating the
parameters from data.
This is especially clear when we sit down to implement such
a model at the computer, because 
the model will be a black box that take in a data
set and return a set of parameter estimates, just like every other model
in this book.
