...
\titleformat{\part}[frame]{\Large\scshape}{\thepart}{.5em}{}{}
...
%\titleformat{\subsection}[awrap]{\bf\scshape}{\thesubsection}{1 em}{}{}
\titleformat{\subsection}[awrap]{\bf\scshape}{}{1 em}{}{}

%code listing:
\lstset{columns=fullflexible}
\def\setlistdefaults{\lstset{frame=single, showstringspaces=false, basicstyle=, language=C, breaklines=true}}
\setlistdefaults
\def\cinline#1{\lstinline[language=C, showstringspaces=false, basicstyle=\scshape,breaklines=true,breakatwhitespace=false,escapechar=\%]{#1}\setlistdefaults}
\def\cinlinetwo#1{\lstinline[language=C, showstringspaces=false, basicstyle=\scshape,breaklines=true,breakatwhitespace=false, escapechar=\%]{#1}}
\def\binline#1{\lstinline[language=bash, showstringspaces=false, basicstyle=\scshape,breaklines=true,breakatwhitespace=false, escapechar=\%]{#1}\setlistdefaults}
\def\binlinetwo#1{\lstinline[language=bash, showstringspaces=false, basicstyle=\scshape,breaklines=true,breakatwhitespace=false, escapechar=\%]{#1}}
\def\sinline#1{\lstinline[language=sql, showstringspaces=false, basicstyle=\scshape,breaklines=true,breakatwhitespace=false, escapechar=\%]{#1}\setlistdefaults}
\def\sinlinetwo#1{\lstinline[language=sql, showstringspaces=false, basicstyle=\scshape,breaklines=true,breakatwhitespace=false, escapechar=\%]{#1}}
...
\comment{ Everything in the preface is in chapter one.
\chapter*{Preface}
\input preface.tex
}
...
[This book is very incomplete. The
...
or re-draw the data so that things will be different. But
...
hopefully I'm doing better here, but it is up to you to know exactly
...
is done via Gnuplot, a program which is freely available and which will compile on
...
that need covering: Chapter \ref{boot} will cover
