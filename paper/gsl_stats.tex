...
\usepackage{natbib,graphicx,epsfig}
...
\title{Statistics with the GNU Scientific Library and Apophenia}
...
first three chapters are finished, but it tapers off from there, to the
point that the last chapter is just a placeholder. I feel that it should
