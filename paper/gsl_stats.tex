...
\usepackage{multicol, array,natbib,graphicx,epsfig,wrapfig, titlesec, apop_wrap, listings,hyphenat,fixltx2e}
...
\def\samplecodelocation{\url{http://apophenia.info/msc_book_samples.zip}}
\def\onlinereflocation{\url{http://apophenia.info/doc}}
...
sufficient to support an argument.
...
interestiprojectionng and persuasive.
}
