...
\titleformat{\chapter}[frame]{\Large\scshape}{\thechapter}{.5em}{\scalebox{0.2}{\includegraphics{flake}}\hfill\flushright}{}
...
\setlength\mwidth{1.3cm}
        %here, commented out, are the one-column versions.
        %They were a pain.
...
%Exercises
%\long\def\exercise#1{\subsection{{\huge$\mathbb Q$}}{#1}
%\begin{center}\parbox{4cm}{\hrule}\end{center}}
\long\def\exercise#1{\vspace \baselineskip
