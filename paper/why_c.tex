...
function is line-for-line identical.} Figures \ref{timefisher} and
...
\ci{apop\_data*} on lines 3, 4, and 6 of Figure \ref{timefisher}) mean
that the computer does not need to guess the data type you mean at every
use, saving time on every calculation.  Pointers and the call-by-reference
