\chapter[Gaussian tricks]{Hypothesis testing with the CLT} \label{gauss}
...
fit the CLT, then please do not use these techniques. Work out how your
data is distributed, 
...
\subsection{Student's t distribution\index{t distribution}}  ${\overline X - \mu \over S/\sqrt{n}}\sim
...
random number generation module (\cinline{gsl/gsl\_randist.h}. Random number generation itself will be delayed to page
...
typically have leptokurtic (fat-tailed) returns.} the bank will report a \ind{value at risk} of {\tt
