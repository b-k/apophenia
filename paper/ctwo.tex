...
\section{Function pointers} Forthcoming.

\exercise{Write a function with header \ci{void apply(double( *fn)(double),
double *array, int array\_len)}, that takes as argumetns a function, an
