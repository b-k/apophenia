...
Floating-point numbers (both \cinline{float} and \cinline{double}) can take three special values: \cinline{Inf}, \cinline{-Inf}, and \cinline{NaN}. Data handlers will mostly be
...
$\Rightarrow$ \cinline{double[ ]} and text file $\Rightarrow$
\cinline{double[ ]}.
