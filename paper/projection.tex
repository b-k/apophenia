...
You'll probably want to plot the \cinline{projected} matrix; I'll continue this example in the chapter on
plotting.
...
returns the first \cinline{dimensions\_we\_want} eigenvectors and all of the eigenvalues. I assume that all of
...
the \cinline{apop\_OLS.estimate} function works, so the remainder of this
...
coefficients in $\beta$ is \cinline{xpx\_inv}.
