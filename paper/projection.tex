...
definitions of \airq{best}.  The standard OLS regression consists of
...
simplification of \cind{apop\_sv\_de\-comp\-osi\-tion}. The function simply makes
...
with ones. 
\begin{lstlisting}
gsl_vector v         = gsl_matrix_column(set->data, 0).vector;
