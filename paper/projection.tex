...
sample covariance is $s_{xy}=\sigma_{xy}\cdot {n\over n-1}$---the
...
but it makes a surprise appearance in Section \ref{ts}. It
...
\paragraph{Bernoulli\index{Bernoulli distribution|textbf}}
...
\paragraph{\ind{Weighted Least Squares}}
