...
\ind{median|(} (see exercise below). For quintiles, one would print the
...
of weighting data; see, e.g., \citet{sarndal:mass}. But if your data includes weightings, then you will
