...
\section{Factor analysis} \label{pca} \ind{factor analysis}
...
\item The columns of $\Xv$ are not colinear (so $\det(\Xv'\Xv)\neq 0$).
\item $N>K$.
\end{itemize}
...
A regression that simply inlcudes a family/classroom/region dummy variable
