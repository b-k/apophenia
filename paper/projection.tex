...
\item There is a one-line function to produce each of these pieces information.
...
lines of linear algebra operations from Chapter \ref{linear_algebra}.
}
...
\section{Data mining} \vocab{Data mining} is an automated search through
...
Modern data mining is a little more subtle than a \ci{for} loop running
