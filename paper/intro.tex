...
\subsection{Dealing with large data sets} Matrix-oriented packages,
...
coefficient, which has an F distribution). \cite[p 141]{kmenta} points out
that no notable natural populations with a Chi-squared distribution.
