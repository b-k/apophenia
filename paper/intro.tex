...
libraries speak.  All of the standards and libraries
...
using these packages for fitting models to data. You could do all of the
...
ideas. The topics broadly fall into three categories: methods for more
efficient computing, methods for estimating the parameters of a model with
data, and methods for testing hypotheses about the parameters of a model.  
\begin{itemize}
\itemsep 0pt
...
Exercises are not designed to be particularly challenging, because you
have your own real-world problems challenging you. Instead, they are an
opportunity to get in the habit of working through problems with the
