...
\marginaliafixed{15}{Evaluation vocab}{
...
function, \cind{apop_maximum_likelihood}---but what a function it is. It
...
most-likely parameter, \cinline{apop_maximum_likelihood} will return an
\cind{apop_estimate} with the variances and other useful information.
...
\item {\bf 200: \ind{Broyden-Fletcher-Goldfarb-Shanno Conjugate gradient algorithm}}  Another conjugate gradient method, that calculates the direction of travel differently. See \cite{avriel:nonlinear} for definitions of all of these methods.
\item {\bf 300: \ind{Polak-Ribiere Conjugate gradient algorithm}} Yet another conjugate gradient method.
