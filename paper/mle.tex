...
it yourself. Fortunately, the GSL has the \cinline{gsl\_multimin} family
of objects, to help you find the optimal parameters. Apophenia even
has an \ttind{apop\_maximum\_likelihood} function that preps and calls
...
do is write a log likelihood function, and \ttind{a\-pop\_\-max\-i\-mum\_\-like\-li\-hood}
...
\cinline{a\-pop\_\-new\_\-like\-li\-hood.\-est\-i\-mate(...)}. For an MLE, this will be one line,
as follows:
\begin{lstlisting}
...
\cinline{a\-pop\_\-new\_\-like\-li\-hood.\-est\-i\-mate(...)}
...
a constraint function, \ttind{apop\_maximum\_likelihood} will combine
