...
around its center. The movement vastly improves the 3-D impresion of the graph.
...
handy.
\begin{lstlisting}
unset border    #Delete the border of the graph.
unset grid      #Make the graph even more minimalist.
