...
\bi{head} and \bi{tail}? [Warning: this is just an exercise,
because \bi{sed} is very inefficient relative to \bi{head} and
\bi{tail}. Try your script on the largest file you have on hand, and
notice how \bi{head} exits as soon as it has read the first ten lines,
while \bi{sed} will read the entire data file.]}
...
be aligned with Dopey's. The \bi{column} addresses exactly this problem,
