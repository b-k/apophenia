...
APOP_VAR_DECLARE void apop_plot_histogram(gsl_vector *data, size_t bin_count, char *with, char *output_file, FILE *output_pipe, char output_type, char output_append);
