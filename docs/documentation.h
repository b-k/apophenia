...
This is the narrative portion of the documentation, detailing how to use the components of the system.
...
they represet a data set where each row is an observation, which includes both numeric
