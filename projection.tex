\chapter{Describing data with projections} \label{projections}
...
The $(X'X)^{-1}$ part can be found by one BLAS function plus the inversion function in Figure \ref{invertmatrix}: \label{ols}
\begin{verbatim}
