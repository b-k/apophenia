...
before the statistician sat down to the computer. The parameters are an intrinsic part of
the model. It is likely that you will have \c NULL data, and will be optimizing the
parameters internal to the model---which means that you need to have an \ref apop_model
...
the <tt>--std=gnu99<\tt> flag on the \c gcc command line.
